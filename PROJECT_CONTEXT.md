...
- **Cambios de UI**: Para ajustes de interfaz/estilo/UX, leer `UI_GUIDELINES.md` como contexto obligatorio. El template CRUD Dashboard de Material UI es la referencia principal de layout y UI; se permite ajustar distribución visual del frontend manteniendo funcionalidad, rutas y lógica de negocio. No modificar backend por cambios de UI.
