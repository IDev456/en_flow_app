...
from app.api.v1.endpoints.daily_board import router as daily_board_router
...
api_router.include_router(daily_board_router, tags=["dashboard"])
...
api_router.include_router(workflows_router, prefix="/flows", tags=["flows"])
